...
<script type="text/html" id="toolbarDemo">
    <div class="layui-btn-container">
        ...
        <button class="layui-btn layui-btn-sm" lay-event="delAction">删除</button>
    </div>
</script>
...
<script>
    layui.use('table', function() {
        ...
        table.render({
            ...
            ,page: true
            ,limit: 10
            , url: '/159000701OSS/actionList' //数据接口
            , cols: [[ //表头
                {type: 'checkbox', fixed: 'left'}
                ,  {field: 'id', title: 'ID', width: 80, sort: true, fixed: 'left'}
                , {field: 'name', title: '功能名', width: 120}
                , {field: 'href', title: '地址', width: 300, sort: true}
                , {field: 'pid', title: '父节点', width: 80}
            ...
            switch (obj.event) {
                ...
                case 'addAction':
                        ...
                        layer.open({
                            ...
                            shade: 0.8,
                            area: ['30%', '60%'],
                            content: ['/159000701OSS/addjsp.do', 'no'] //iframe的url
                        });
