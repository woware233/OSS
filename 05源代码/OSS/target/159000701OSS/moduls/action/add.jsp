<%@ page import="com.oss.domain.Action" %><%--
...
<form class="layui-form" action="/159000701OSS/addAction" style="width: 80%;margin-top: 50px">
    <div class="layui-form-item">
        <label class="layui-form-label">功能名</label>
        <div class="layui-input-block">
            <input type="text" name="name" required  lay-verify="required" placeholder="请输入功能名" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">地址</label>
        <div class="layui-input-block">
            <input type="text" name="href" required lay-verify="required" placeholder="请输入地址" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <select name="pid" lay-verify="required">
                ...
                <c:forEach items="${requestScope.action}" var="item">
