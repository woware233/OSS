...
<body>
<form class="layui-form" action="/159000701OSS/addBatch" style="width: 80%;margin-top: 50px">
    <div class="layui-form-item">
        <label class="layui-form-label">批次名</label>
        <div class="layui-input-block">
            <input type="text" name="batchname" required  lay-verify="required" placeholder="请输入批次名" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">起始时间</label>
        <div class="layui-input-block">
            <input type="text" name="batchcdate" required  lay-verify="required" placeholder="请输入时间" autocomplete="off" class="layui-input" id="test1">
        </div>
    </div>
    <div class="layui-form-item">
