...
<script>
    layui.use('table', function() {
        ...
        table.render({
            ...
            ,page: true
            ,limit: 10
            , url: '/159000701OSS/BatchCourseList' //数据接口

            , cols: [[ //表头
                {type: 'checkbox', fixed: 'left'}
                ,  {field: 'batchid', title: '批次ID', width: 80, sort: true, fixed: 'left'}
                , {field: 'batchname', title: '批次名', width: 120}
                ,  {field: 'courseid', title: '课程ID', width: 80, sort: true}
            ...
            switch (obj.event) {
                ...
                case 'addBatch':
                    ...
                    layer.open({
                        ...
                        shade: 0.8,
                        area: ['30%', '60%'],
                        content: ['/159000701OSS/BCaddjsp.do', 'no']
                    });
                    break;
                case 'delBatch':
                    var ids = ""
